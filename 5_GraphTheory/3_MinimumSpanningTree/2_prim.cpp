...
//
//我忠实的实现了算法导论中的伪语言，其中使用了自定义的边集edge_list数据结构
//形式有所不同但本质不变
//读者也可参考本书最短路径一节中的Dijkstra算法来考虑Prim算法的另一种更为流行的实现
//其中主要通过设置路径数组path来记录生成树的边
