...
#ifndef SEARCH_DANCINGLINKS_HPP
#define SEARCH_DANCINGLINKS_HPP
...
/* up_node[i]/down_node[i]/left_node[i]/right_node[i]
 * 对应分别为节点i上方/下方/左方/右方的邻节点 */
