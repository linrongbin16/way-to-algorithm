...
int main()
{
    ...
    gl.g_l[0].push_back(no[1]);
    gl.g_l[0].push_back(no[2]);
    gl.g_l[1].push_back(no[3]);
    gl.g_l[2].push_back(no[3]);
    gl.g_l[2].push_back(no[4]);
    gl.g_l[3].push_back(no[5]);
    gl.g_l[3].push_back(no[0]);
    ...
    g2.g_l[0].push_back(gn2[1]);
    g2.g_l[0].push_back(gn2[2]);
    g2.g_l[1].push_back(gn2[0]);
    g2.g_l[1].push_back(gn2[3]);
    g2.g_l[2].push_back(gn2[0]);
    g2.g_l[2].push_back(gn2[5]);
    g2.g_l[2].push_back(gn2[6]);
    g2.g_l[2].push_back(gn2[9]);
    g2.g_l[3].push_back(gn2[1]);
    g2.g_l[3].push_back(gn2[4]);
    g2.g_l[3].push_back(gn2[7]);
    g2.g_l[4].push_back(gn2[3]);
    g2.g_l[4].push_back(gn2[7]);
    g2.g_l[4].push_back(gn2[8]);
    g2.g_l[5].push_back(gn2[2]);
    g2.g_l[5].push_back(gn2[6]);
    g2.g_l[6].push_back(gn2[2]);
    g2.g_l[6].push_back(gn2[5]);
    g2.g_l[6].push_back(gn2[9]);
    g2.g_l[6].push_back(gn2[10]);
    g2.g_l[7].push_back(gn2[3]);
    g2.g_l[7].push_back(gn2[4]);
    g2.g_l[7].push_back(gn2[8]);
    g2.g_l[8].push_back(gn2[4]);
    g2.g_l[8].push_back(gn2[7]);
    g2.g_l[8].push_back(gn2[11]);
    g2.g_l[9].push_back(gn2[6]);
    g2.g_l[9].push_back(gn2[10]);
    g2.g_l[9].push_back(gn2[2]);
    g2.g_l[10].push_back(gn2[6]);
    g2.g_l[10].push_back(gn2[9]);
    g2.g_l[11].push_back(gn2[8]);
    g2.g_l[11].push_back(gn2[12]);
    g2.g_l[11].push_back(gn2[13]);
    g2.g_l[12].push_back(gn2[11]);
    g2.g_l[12].push_back(gn2[14]);
    g2.g_l[13].push_back(gn2[11]);
    g2.g_l[13].push_back(gn2[14]);
    g2.g_l[14].push_back(gn2[12]);
    g2.g_l[14].push_back(gn2[13]);
    ...
    cout << endl
         << "double connected component:" << endl;
    ...
    g3.g_l[0].push_back(n3[1]);
    g3.g_l[0].push_back(n3[2]);
    g3.g_l[0].push_back(n3[5]);
    g3.g_l[1].push_back(n3[3]);
    g3.g_l[1].push_back(n3[4]);
    g3.g_l[5].push_back(n3[7]);
    g3.g_l[5].push_back(n3[8]);
    g3.g_l[5].push_back(n3[6]);

    g3.g_l[8].push_back(n3[10]);
    g3.g_l[8].push_back(n3[9]);

    cout << endl
         << "least common ancestors:" << endl;
