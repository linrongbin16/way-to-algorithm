...
&emsp;&emsp;\(34_{10} \quad \& \quad (- 34_{10} ) = 0010,0010_{2} \quad \& \quad 1101,1110_{2} = 10_{2} = 2_{10}\)； <br>
&emsp;&emsp;\(12_{10} \quad \& \quad (- 12_{10} ) = 0000,1100_{2} \quad \& \quad 1111,0100_{2} = 100_{2} = 4_{10}\)； <br>
&emsp;&emsp;\(8_{10} \quad \& \quad (- 8_{10} ) = 0000,1000_{2} \quad \& \quad 1111,1000_{2} = 1000_2 = 8_{10}\)； <br>
