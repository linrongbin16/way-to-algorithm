...
| $$ \vee $$                      | 逻辑或     | 或                 | $$ x \vee y \text{define} \\ \begin{cases} 0 & x=0, y=0 \\ 1 & other cases \end{cases} $$                             | $$ 1 \vee 0 = 1, 0 \vee 0 = 0 $$                            |
| $$ \oplus $$                    | 异或       | 异或               | $$ x \oplus y \text{define} \\ \begin{cases} 0 & x=y \\ 1 & x \ne y \end{cases} $$                                    | $$ 1 \oplus 0 = 1, 0 \oplus 0 = 0 $$                        |
| $$ \in $$                       | 属于       | 属于               | $$ x \in y \text{define} \\ y = {x, \dots } $$                                                                        | $$ 1 \in \{1, 2, 3\} $$                                     |
| $$ \notin $$                    | 不属于     | 不属于             | $$ x \notin y \text{define} \\ y \ne {x, \dots } $$                                                                   | $$ 4 \notin \{1, 2, 3\} $$                                  |
| $$ \forall $$                   | 任意符号   | 对任意的           | $$ \forall x \text{define} \\ \text{for every} x $$                                                                   | $$ \forall x \in \{1, 2, 3\} $$                             |
| $$ \exists $$                   | 存在符号   | 存在               | $$ \exists x \text{define} \\ \text{has} x $$                                                                         | $$ \exists x $$                                             |
| $$ \varnothing $$               | 空集       | 空集               | $$ \varnothing \text{define} \\ {} $$                                                                                 | $$ \varnothing \subset \{1\} $$                             |
| $$ \cap $$                      | 交集       | 交                 | $$ x \cap y \text{define} \\ {e, e \in x \wedge x \in y } $$                                                          | $$ \{1, 2, 3\} \cap \{2, 3, 4\}  = \{2, 3\} $$              |
| $$ \cup $$                      | 并集       | 并                 | $$ x \cup y \text{define} \\ {e, e \in x \vee e \in y } $$                                                            | $$ \{1, 2, 3\} \cap \{2, 3, 4\}  = \{1, 2, 3, 4\} $$        |
| $$ \subseteq $$                 | 子集       | 左边是右边的子集   | $$ x \subseteq y \text{define} \\ {e, \forall e \in x \rightarrow e \in y, \exists e \in y \rightarrow e \notin x} $$ | $$ \{1, 2, 3\} \subseteq \{1, 2, 3\} $$                     |
| $$ \supseteq $$                 | 子集       | 右边是左边的子集   | $$ y \supseteq x \text{define} \\ {e, \forall e \in y \rightarrow e \in x, \exists e \in x \rightarrow e \notin y} $$ | $$ \{1, 2, 3\} \supseteq \{1, 2, 3\} $$                     |
| $$ \nsubseteq $$                | 非子集     | 左边不是右边的子集 | $$ x \nsubseteq y \text{define} \\ not x \subseteq y $$                                                               | $$ \{4\} \nsubseteq \{1, 2, 3\} $$                          |
| $$ \nsupseteq $$                | 非子集     | 右边不是左边的子集 | $$ y \nsupseteq x \text{define} \\ not y \subseteq x $$                                                               | $$ \{1, 2, 3\} \nsupseteq \{0\} $$                          |
| $$ \subset $$                   | 真子集     | 左边是右边的真子集 | $$ x \subset y \text{define} \\  x \neq y, x \subseteq y $$                                                           | $$ \{1\} \subset \{1, 2, 3\} $$                             |
| $$ \supset $$                   | 真子集     | 右边是左边的真子集 | $$ y \supset x \text{define} \\ y \neq x, y \subseteq x $$                                                            | $$ \{1, 2, 3\} \supset \{1\} $$                             |
| $$ \backslash $$                | 补集       | 除去               | $$ x \backslash y \text{define} \\ {e, e \in y \rightarrow e \notin x } $$                                            | $$ \{1, 2, 3\} \backslash \{3, 4, 5\} = \{1, 2\} $$         |
| $$ \infty $$                    | 无穷       | 无穷               | $$ +\infty, -\infty \text{define} \\ \forall x \rightarrow -\infty \lt x \lt +\infty $$                               | $$ -\infty \lt 0 \lt +\infty $$                             |
| $$ \leftarrow $$                | 左箭头     | 向左               | $$ \leftarrow $$                                                                                                      | $$ x \leftarrow y $$                                        |
| $$ \rightarrow $$               | 右箭头     | 向右               | $$ \rightarrow $$                                                                                                     | $$ x \rightarrow y $$                                       |
