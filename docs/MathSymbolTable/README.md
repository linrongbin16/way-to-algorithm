...
| $$ \sqrt x $$                   | 根号       | 开方根             | $$ \sqrt [n] x $$                                                            | $$ \sqrt 9 = 3, \sqrt [3] {27} = 3 $$                       |
| $$ \mid \mid$$                  | 绝对值     | 绝对值             | $$ \mid x \mid $$                                                            | $$ \mid -1 \mid = 1 $$                                      |
| $$ ! $$                         | 阶乘       | 阶乘               | $$ n! $$                                                                     | $$ 0! = 1, 3! = 1 \times 2 \times 3 = 6 $$                  |
| $$ P_{k}^{n} $$                 | 排列       | 排列               | $$ P_{k}^{n} = \frac{n!}{(n-k)!} $$                                          | $$ P_{3}^{8} = \frac{8!}{(8-3)!} = 336 $$                   |
| $$ C_{k}^{n}, \binom{n} {k}  $$ | 组合       | 组合               | $$ C_{k}^{n} = \binom{n} {k} = \frac{P_{k}^{n}}{k!} = \frac{n!}{k!(n-k)!} $$ | $$ C_{3}^{8} = \frac{8!}{3! \times (8-3)!} = 56 $$          |
...
| $$ \cap $$                      | 交集       | 交                 | $$ x \cap y $$                                                               | $$ \{1, 2, 3\} \cap \{2, 3, 4\}  = \{2, 3\} $$              |
| $$ \cup $$                      | 并集       | 并                 | $$ x \cup y $$                                                               | $$ \{1, 2, 3\} \cap \{2, 3, 4\}  = \{1, 2, 3, 4\} $$        |
...
| $$ \infty $$                    | 无穷       | 无穷               | $$ +\infty, -\infty $$                                                       | $$ -\infty \lt 0 \lt +\infty $$                             |
