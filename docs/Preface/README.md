...
gitbook的发布方式是我目前找到的最好的方法，支持静态markdown文档页面、Latex公式、SVG图片、展示源码、集成github代码库等，能够支撑书籍需要的所有功能。

但由于gitbook的插件mathjax对website和ebook的支持存在bug，目前通过浏览器访问需要两次刷新才能正确显示Latex公式，而且pdf也无法正确下载。这些bug可能需要更久的时间等待gitbook及相关作者的修复，或者找到其它更好的替换方案。
